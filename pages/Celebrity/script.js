...
.then(res => {
    reload(res.data.cast.slice(0,4),document.querySelector('.mn_block_best_films'),Movie)
})
getImagesAcc(actorId)
.then(res => reload(res.data.profiles.slice(0,6),document.querySelector(".mn_images_grid"),ImagesAcc))
