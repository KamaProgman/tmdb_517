...
getStarring(movieId)
    .then(res => reload(res.data.cast.slice(0, 8),
...
getMovieTrailers(movieId)
    ...
    .catch(error => console.error(error))
getPosters(movieId)
    .then(res => console.log(res.posters)) 
    .catch(error => console.error(error))
    getSimilar(movieId)
    .then(res => reload(res.data.results.slice(0,4),document.querySelector('.mn_similar_box'),Movie))